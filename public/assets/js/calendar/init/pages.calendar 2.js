...
(function(factory) {
            ...
            */
            getEventByID:function(id){
                for (var item in Calendar.settings.events) {
                    if(Calendar.settings.events[item].other.id == id){
                        return Calendar.settings.events[item];
                    }
                }
             return null;
            },
        ...
        Calendar = {
            ...
            Init: function(rebuild) {
                ...
                if (this.settings.now != null) {
                    ...
                    if(moment().format("dddd") === "samedi") {
                        calendar.date = moment().add(2, 'days').format("D");
                        calendar.dayOfWeek = moment().add(2, 'days').day();
                    }else if(moment().format("dddd") === "dimanche") {
                        calendar.date = moment().add(1, 'days').format("D");
                        calendar.dayOfWeek = moment().add(1, 'days').day();
                    } else {
                ...
                if(!Calendar.settings.weekends){
                    Calendar.settings.ui.week.startOfTheWeek = 0;
                    Calendar.settings.ui.week.endOfTheWeek = 4;
                }
            ...
            _addEvents: function(eventArray) {
                ...
                if(id != null) {
                    ...
                    plugin.settings.onEventClick(EventManager.getEventByID(id));
                }
    ...
    */
     ...
     * @return {array}
    */
    PagesCalendar.prototype.getEventArray = function(option) {
